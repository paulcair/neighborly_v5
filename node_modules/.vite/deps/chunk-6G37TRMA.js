...
import {
  Ethereum,
  defaultChains
} from "./chunk-E3VUPDZQ.js";
import {
  WagmiAdapter
} from "./chunk-6QJQBKJF.js";
import {
...
var PaperWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-WNOIXRVR.js");
...
var DeviceWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-device-wallet.browser.esm-6ZB36E66.js");
...
async function defaultEncrypt(message, password) {
  const cryptoJS = (await import("./crypto-js-722OQQNY.js")).default;
...
var WalletConnect = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-NPTKHBIQ.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-KIVP3V2J.js");
...
var CoinbaseWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-T2R4UZCA.js");
...
var InjectedWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-UJEOMEKF.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-3UKYAZGC.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-ETWVFQEV.js");
...
//# sourceMappingURL=chunk-6G37TRMA.js.map
