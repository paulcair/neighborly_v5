...
var WalletConnectV1Connector = class extends Connector {
  ...
  async getProvider() {
    ...
    if (!_classPrivateFieldGet(this, _provider) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./index-42b0f5f5.browser.esm-Z46JHZRJ.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-ETWVFQEV.js.map
